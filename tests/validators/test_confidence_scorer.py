...
class TestConfidenceScorer:
    ...
    def test_high_confidence_movie_complete(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
        """Test high confidence for complete movie."""
        result: ConfidenceLevel = scorer.score(base_item)
        assert result == ConfidenceLevel.HIGH

    def test_high_confidence_movie_with_language(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
        """Test high confidence for movie with language code."""
        base_item.language = "CZ"
        result: ConfidenceLevel = scorer.score(base_item)
        assert result == ConfidenceLevel.HIGH

    def test_medium_confidence_movie_without_year(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
    ...
    def test_low_confidence_with_issues(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
    ...
    def test_medium_confidence_tv_episode_complete(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
    ...
    def test_high_confidence_tv_episode_with_title(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
    ...
    def test_low_confidence_very_low_parser_score(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
        """Test low confidence when parser score is very low."""
        base_item.confidence = 0.5
        result: ConfidenceLevel = scorer.score(base_item)
        assert result == ConfidenceLevel.LOW

    def test_boundary_high_threshold(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
    ...
    def test_boundary_below_high_threshold(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
        """Test just below high confidence threshold."""
        base_item.confidence = scorer.HIGH_THRESHOLD - 0.01
        result: ConfidenceLevel = scorer.score(base_item)
        assert result == ConfidenceLevel.MEDIUM

    def test_boundary_medium_threshold(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
    ...
    def test_boundary_below_medium_threshold(self, scorer: ConfidenceScorer, base_item: ParsedMediaItem) -> None:
